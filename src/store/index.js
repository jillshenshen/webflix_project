  ...
  export const getSearch = createAsyncThunk(
    ...
    async (input, thunkApi) => {
      ...
      const {
        ...
        `${TMDB_BASE_URL}/search/multi?api_key=${API_KEY}&query=${input}`
      );
      const searchArray = [];
  ...
  export const homeInfo = createAsyncThunk(
    ...
    async (payload) => {
      const {
        ...
        `${TMDB_BASE_URL}/${payload.movieType}/${payload.id}?api_key=${API_KEY}`
      );
      const infoArray = [];
      infoArray.push({
        info: overview,
  ...
  export const getTrailer = createAsyncThunk(
    ...
    async (payload) => {
      const {
        ...
        `${TMDB_BASE_URL}/${payload.movieType}/${payload.id}/videos?api_key=${API_KEY}`
      );
